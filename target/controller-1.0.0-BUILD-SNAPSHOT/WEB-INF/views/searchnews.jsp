						...
						<div id="body-main-cont" class="left relative">
							<div id="leader-wrap" class="left relative">
							  <div
							     ...
							     <textarea id="txt" class= "truyvan" style="width: 100%; height: 50px; display:none;" disabled>Query:${news}  RESPONSE:${data}</textarea>
							  </div>
							</div>
							<!--leader-wrap-->
										...
										<div id="sidebar-wrap" class="left relative">
											<div class="widget-ad left relative">
												<c:forEach var="pages" items="${homes}">
													<a href="<c:url value="/details/${pages.id}"/>"
														target="_blank"> <img src=${pages.cover_url } />
													</a>
												</c:forEach>
											</div>
											<!--widget-ad-->
											<div id="mvp_facebook_widget-3"
												...
												<h4 class="post-header">
													<span class="post-header">Facebook</span>
												</h4>
												<div class="fb-page"
													data-href="https://www.facebook.com/railstutorial/?fref=ts"
