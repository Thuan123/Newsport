									...
									<div class="home-wrap-in1">
										<div id="home-left-wrap" class="left relative">
											<div id="home-left-col" class="relative">
												<h1 class="cat-head">Related News</h1>
									...
									<div id="arch-right-col" class="relative">
										<div id="sidebar-wrap" class="left relative">
											<div class="widget-ad left relative">
												...
												<a href="<c:url value="/details/${newfeats.id}"/>" target="_blank"> <img
													src=${newfeats.cover_url}/>
												</a>
												</c:forEach>
											</div>
											<!--widget-ad-->
											...
											<div id="mvp_catlist_widget-7"
												...
												<div class="blog-widget-wrap left relative">
													<ul class="blog-widget-list left relative">
														...
														<li><a href="<c:url value="/details/${newmenus.id}"/>">
																<div class="blog-widget-img left relative">
																	<img src=${newmenus.cover_url} alt="" width="300px"
																		height="180px" class="widget-img-main wp-post-image"
																		alt="woman-beach2"
